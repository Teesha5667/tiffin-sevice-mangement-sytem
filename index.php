...
{               ?>
						<div class="col-md-3" data-wow-delay="0.4s">
							...
							<label style="padding-top: 20px;padding-bottom: 20px"><?php  echo htmlentities($row->Title);?>:<i class="fa fa-inr" aria-hidden="true"></i>
							<?php  echo htmlentities($row->Cost);?></label>
